  ...
  return (
    <div className="container mx-auto max-w-4xl py-24 px-4">
      ...
      <p className="text-center mb-10 text-gray-600">
        Please select the type of profile you want to create and fill out the required information.
      </p>

      <Tabs defaultValue={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-2 mb-8">
          <TabsTrigger value="chef">Chef Profile</TabsTrigger>
            ...
            <CardContent>
              <Form {...chefForm}>
                <form onSubmit={chefForm.handleSubmit(onChefSubmit)} className="space-y-6">
                  ...
                  <h3 className="text-lg font-medium">Social Media & Portfolio (Optional)</h3>
        ...
        <TabsContent value="business">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Create your business profile to find talented chefs for your establishment.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Form {...businessForm}>
                <form onSubmit={businessForm.handleSubmit(onBusinessSubmit)} className="space-y-6">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Your Restaurant or Establishment" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea 
                            placeholder="Tell chefs about your business, your cuisine style, and your requirements..."
                            className="min-h-[120px]"
                            {...field} 
                          />
                        </FormControl>
                  ...
                  <h3 className="text-lg font-medium">Business Links (Optional)</h3>
